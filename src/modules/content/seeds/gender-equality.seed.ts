...
`,
    ...
    {
      subtopicCode: 'UNDERSTANDING_GENDER',
      nodeKey: 'UNDERSTANDING_GENDER_08_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'UNDERSTANDING_GENDER',
      nodeKey: 'UNDERSTANDING_GENDER_08_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'UNDERSTANDING_GENDER',
      nodeKey: 'UNDERSTANDING_GENDER_08_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'UNDERSTANDING_GENDER',
      nodeKey: 'UNDERSTANDING_GENDER_08_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
`,
    ...
    {
      subtopicCode: 'GENDER_ROLES_AND_STEREOTYPES',
      nodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'GENDER_ROLES_AND_STEREOTYPES',
      nodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'GENDER_ROLES_AND_STEREOTYPES',
      nodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'GENDER_ROLES_AND_STEREOTYPES',
      nodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
Je, ungependa kujifunza zaidi kuhusu ridhaa, kutambua unyanyasaji wa kijinsia, kuripoti ukatili, kumsaidia manusura, au wapi pa kupata msaada? Niko hapa kukusaidia.`,
    ...
    {
      subtopicCode: 'TYPES_OF_VIOLENCE',
      nodeKey: 'TYPES_OF_VIOLENCE_17_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TYPES_OF_VIOLENCE',
      nodeKey: 'TYPES_OF_VIOLENCE_17_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TYPES_OF_VIOLENCE',
      nodeKey: 'TYPES_OF_VIOLENCE_17_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'TYPES_OF_VIOLENCE',
      nodeKey: 'TYPES_OF_VIOLENCE_17_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
J: Ndiyo. Kila mtoto anastahili kutendewa sawa na fursa.`,
    ...
    {
      subtopicCode: 'CHILDRENS_RIGHTS',
      nodeKey: 'CHILDRENS_RIGHTS_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CHILDRENS_RIGHTS',
      nodeKey: 'CHILDRENS_RIGHTS_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CHILDRENS_RIGHTS',
      nodeKey: 'CHILDRENS_RIGHTS_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'CHILDRENS_RIGHTS',
      nodeKey: 'CHILDRENS_RIGHTS_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
Ukweli: Kila mtoto ana haki bila kujali malezi yake.`,
    ...
    {
      subtopicCode: 'ADOLESCENTS_RIGHTS',
      nodeKey: 'ADOLESCENTS_RIGHTS_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_RIGHTS',
      nodeKey: 'ADOLESCENTS_RIGHTS_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_RIGHTS',
      nodeKey: 'ADOLESCENTS_RIGHTS_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'ADOLESCENTS_RIGHTS',
      nodeKey: 'ADOLESCENTS_RIGHTS_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
Kuripoti vurugu kunaweza kukusaidia kupata ulinzi na usaidizi, na kunaweza pia kuzuia watoto wengine na vijana kupata madhara kama hayo.`,
    ...
    {
      subtopicCode: 'PROTECTION_FROM_ABUSE',
      nodeKey: 'PROTECTION_FROM_ABUSE_09_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'PROTECTION_FROM_ABUSE',
      nodeKey: 'PROTECTION_FROM_ABUSE_09_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'PROTECTION_FROM_ABUSE',
      nodeKey: 'PROTECTION_FROM_ABUSE_09_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'PROTECTION_FROM_ABUSE',
      nodeKey: 'PROTECTION_FROM_ABUSE_09_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
● Ukihisi hauko salama, zungumza na mtu mzima unayemwamini haraka iwezekanavyo.`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Every young person deserves the chance to grow, learn, and make decisions about their future when they are ready.
Child marriage is a marriage involving a child or adolescent under the age of 18.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kila kijana anastahili nafasi ya kukua, kujifunza, na kufanya maamuzi kuhusu mustakabali wake anapokuwa tayari.
Ndoa ya utotoni ni ndoa inayohusisha mtoto au kijana aliye chini ya umri wa miaka 18.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `At this age, many children are still developing physically, mentally, emotionally, and socially, which means they are often not yet ready for the responsibilities of marriage and parenthood.
Child marriage can happen for different reasons, including poverty, customs and traditions, lack of education, early pregnancy, or pressure from family and society.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Katika umri huu, watoto wengi bado wanaendelea kukua kimwili, kiakili, kihisia, na kijamii, kumaanisha kuwa mara nyingi hawako tayari kwa majukumu ya ndoa na uzazi.
Ndoa ya utotoni inaweza kutokea kwa sababu tofauti, ikiwa ni pamoja na umaskini, mila na desturi, ukosefu wa elimu, mimba za mapema, au shinikizo kutoka kwa familia na jamii.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Child marriage can have a profound impact on a young person's life.
It often interrupts education, limits opportunities for personal growth and development, and increases economic dependence.
A decision made too early can affect many aspects of a person's future.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ndoa ya utotoni inaweza kuwa na athari kubwa katika maisha ya kijana.
Mara nyingi hukatiza elimu, hupunguza fursa za ukuaji na maendeleo binafsi, na huongeza utegemezi wa kiuchumi.
Uamuzi uliofanywa mapema sana unaweza kuathiri vipengele vingi vya mustakabali wa mtu.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For girls, child marriage increases the risk of early pregnancy, which can create health challenges for both the mother and the baby.
It can also increase the likelihood of experiencing sexual violence, emotional abuse, and having little or no control over decisions that affect their own lives.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kwa wasichana, ndoa ya utotoni huongeza hatari ya mimba za mapema, ambayo inaweza kusababisha changamoto za kiafya kwa mama na mtoto.
Inaweza pia kuongeza uwezekano wa kupata ukatili wa kijinsia, unyanyasaji wa kihisia, na kuwa na udhibiti mdogo au kutodhibiti kabisa maamuzi yanayoathiri maisha yao wenyewe.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Every child has the right to education, good health, protection, and the opportunity to decide their own future.
Marriage should never take away these rights or prevent a young person from achieving their goals and dreams.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kila mtoto ana haki ya kupata elimu, afya njema, ulinzi, na fursa ya kuamua mustakabali wake mwenyewe.
Ndoa haipaswi kamwe kuondoa haki hizi au kumzuia kijana mtu asifikie malengo na ndoto zao.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `It's also important to remember that marriage is not a solution to financial or social challenges.
While families may face difficult circumstances, education, life skills, and economic empowerment can provide young people with better opportunities and help them build a brighter future.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ni muhimu pia kukumbuka kwamba ndoa si suluhisho la changamoto za kifedha au kijamii.
Ingawa familia zinaweza kukabiliwa na hali ngumu, elimu, ujuzi wa maisha, na uwezeshaji wa kiuchumi vinaweza kuwapa vijana fursa bora na kuwasaidia kujenga mustakabali mzuri zaidi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_07',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you feel that you are being forced into marriage, or if you know a child who may be facing this situation, you do not have to face it alone.
Talk to a trusted parent, guardian, teacher, community leader, social welfare officer, or another trusted adult who can help protect your rights and connect you with the support you need.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ukihisi kwamba unalazimishwa kuolewa, au ikiwa unamjua mtoto ambaye anaweza kuwa anakabiliwa na hali hii, huna haja ya kukabiliana nayo peke yako.
Zungumza na mzazi, mlezi, mwalimu, kiongozi wa jamii, afisa wa ustawi wa jamii, au mtu mzima mwingine anayeaminika ambaye anaweza kusaidia kulinda haki zako na kukuunganisha na usaidizi unaohitaji.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_08',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `No, but would you like to learn more about children's rights, healthy relationships, gender equality, or where to seek help if someone is at risk of child marriage? I'm here to support you.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Hapana, Je ungependa kujifunza zaidi kuhusu haki za watoto, mahusiano mazuri, usawa wa kijinsia, au wapi pa kutafuta msaada ikiwa mtu yuko katika hatari ya ndoa ya utotoni? Niko hapa kukusaidia.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_09_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_09_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_09_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_09_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_REFRESHER_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Child marriages - something important to know.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ndoa za utotoni - jambo muhimu kulijua.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_REFRESHER_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `● Marriage involving a child under the age of 18 is called child marriage, and it has serious consequences for their lives.
● It often leads to interruption of education, health risks, and loss of future opportunities.
● Education and life skills are the best way to build a better life, not early marriage.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `● Ndoa inayohusisha mtoto chini ya miaka 18 huitwa ndoa ya utotoni, na ina madhara makubwa kwa maisha yake.
● Mara nyingi husababisha kukatika kwa masomo, hatari za kiafya, na kupoteza fursa za baadaye.
● Elimu na ujuzi wa maisha ni njia bora zaidi ya kujenga maisha bora, si ndoa ya mapema.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CHILDS_MARRIAGE',
      nodeKey: 'CHILDS_MARRIAGE_REFRESHER_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Do you feel forced into marriage or know someone in this situation? Tell us immediately, we are here to help.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Unahisi unalazimishwa kuolewa au unamjua mtu katika hali hii? Tuambie mara moja, tuko hapa kusaidia.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for asking about sexual exploitation.
Understanding what it is can help you recognize unsafe situations, protect yourself, and support others who may need help.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Asante kwa kuuliza kuhusu unyonyaji wa kingono.
Kuelewa ni nini kunaweza kukusaidia kutambua hali zisizo salama, kujilinda, na kuwasaidia wengine ambao wanaweza kuhitaji msaada.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
...
This is never the young person's fault.
Sexual exploitation does not always involve physical force. It can also happen through threats, deception, promises of help, or by taking advantage of a young person's difficult circumstances to pressure or persuade them into sexual activities.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Unyonyaji wa kingono hutokea wakati mtu anatumia nguvu zake, umri, cheo, pesa, zawadi, ahadi, au ushawishi wake kupata manufaa ya kingono kutoka kwa mtoto au kijana.
Hili kamwe si kosa la kijana.
Unyonyaji wa kingono hauhusishi nguvu za kimwili kila wakati. Unaweza pia kutokea kupitia vitisho, udanganyifu, ahadi za msaada, au kwa kutumia mazingira magumu ya kijana kumshinikiza au kumshawishi ajiunge na shughuli za kingono.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `In the Tanzanian context, sexual exploitation can take many forms.
For example, an adult may offer a student money, vouchers, transportation, gifts, or promise academic support in exchange for sexual relations.
It can also happen when someone demands sex in exchange for services, employment, school grades, or other opportunities.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Katika muktadha wa Tanzania, unyonyaji wa kingono unaweza kuchukua aina nyingi.
Kwa mfano, mtu mzima anaweza kumpa mwanafunzi pesa, vocha, usafiri, zawadi, au ahadi ya usaidizi wa kitaaluma badala ya mahusiano ya kingono.
Inaweza pia kutokea wakati mtu anadai ngono badala ya huduma, ajira, alama za shule, au fursa zingine.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `These situations may sometimes appear helpful, caring, or affectionate, making them difficult to recognize.
However, if someone expects sexual activity in return for assistance or opportunities, this is a form of sexual exploitation.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Hali hizi wakati mwingine zinaweza kuonekana kuwa za kusaidia, za kujali, au za upendo, na kufanya iwe vigumu kuzitambua.
Hata hivyo, ikiwa mtu anatarajia shughuli za kingono kama malipo ya msaada au fursa, hii ni aina ya unyonyaji wa kingono.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Sexual exploitation can have serious consequences.
It may lead to emotional pain, loss of self-esteem, unintended pregnancy, HIV and other sexually transmitted infections (STIs), and can affect a young person's education, future opportunities, and overall development.
No one deserves to experience these harms, and support is available.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Unyonyaji wa kingono unaweza kuwa na matokeo mabaya.
Inaweza kusababisha maumivu ya kihisia, kupoteza kujithamini, mimba zisizotarajiwa, VVU na magonjwa mengine ya zinaa (STI), na inaweza kuathiri elimu ya kijana, fursa za baadaye, na maendeleo kwa ujumla.
Hakuna mtu anayestahili kupata madhara haya, na usaidizi unapatikana.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `It is important to remember that no one should ever give or receive money, gifts, services, opportunities, or favors in exchange for sexual activity.
Healthy relationships are built on mutual respect, equality, trust, and genuine consent-not on pressure, fear, dependence, or the fear of losing support.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ni muhimu kukumbuka kwamba hakuna mtu anayepaswa kutoa au kupokea pesa, zawadi, huduma, fursa, au neema badala ya shughuli za ngono.
Mahusiano mazuri yanajengwa juu ya heshima ya pande zote, usawa, uaminifu, na ridhaa ya kweli-sio kwa shinikizo, hofu, utegemezi, au hofu ya kupoteza usaidizi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_07',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If someone is making you feel pressured, uncomfortable, or as though you "owe" them sexual activity because they have helped you, it is important to know that this is not your fault, and you have the right to say no.
You deserve to feel safe and respected.`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ikiwa mtu anakufanya uhisi kushinikizwa, kutokuwa na raha, au kana kwamba "unadaiwa" shughuli za ngono kwa sababu amekusaidia, ni muhimu kujua kwamba hii si kosa lako, na una haki ya kusema hapana.
Unastahili kujisikia salama na kuheshimiwa.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_08',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you or someone you know is experiencing sexual exploitation, talk to a trusted adult, parent, guardian, teacher, school counselor, healthcare provider, social welfare officer, or report the situation to the relevant authorities.
Seeking help is a courageous step that can protect you and connect you with the support you deserve.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ikiwa wewe au mtu unayemjua anapitia unyonyaji wa kingono, zungumza na mtu mzima unayemwamini, mzazi, mlezi, mwalimu, mshauri wa shule, mtoa huduma ya afya, afisa wa ustawi wa jamii, au ripoti hali hiyo kwa mamlaka husika.
Kutafuta msaada ni hatua ya ujasiri ambayo inaweza kukulinda na kukuunganisha na usaidizi unaostahili.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_09',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Would you like to learn more about consent, healthy relationships, recognizing grooming behaviors, or where to get help if you feel unsafe? I'm here to support you.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ungependa kujifunza zaidi kuhusu ridhaa, mahusiano mazuri, kutambua tabia za kujipamba, au wapi pa kupata msaada ikiwa unajisikia salama? Niko hapa kukusaidia.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_10',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you need health information, HIV testing, family planning services, pregnancy-related care, mental health support, protection from violence or help with abuse, you do not have to face it alone.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Sexual exploitation - something to understand better.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Unyonyaji wa kingono - jambo la kuelewa vizuri.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `● Sexual exploitation occurs when someone uses money, gifts, or promises to get sexual favors from you.
● It often does not come as direct force - it comes as "help" or "love".
● Remember: no one should ever give sex in return for help, gifts, or opportunities.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `● Unyonyaji wa kingono hutokea mtu anapotumia fedha, zawadi, au ahadi kupata mapenzi ya kingono kutoka kwako.
● Mara nyingi haujitokezi kama nguvu ya moja kwa moja - huja kama "msaada" au "upendo".
● Kumbuka: hakuna anayepaswa kutoa ngono kama malipo ya msaada, zawadi, au fursa.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'SEXUAL_EXPLOITATION',
      nodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Do you feel like you are being used in this way? Tell us, we are here to help and protect you.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Unahisi unatumiwa kwa njia hii? Tuambie, tuko hapa kukusaidia na kukulinda.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Understanding healthy and unhealthy relationships can help you make informed decisions and protect your wellbeing.
Transactional relationships occur when one person provides money, gifts, material support, or other benefits while expecting a romantic or sexual relationship in return.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kuelewa mahusiano yenye afya na yasiyo na afya kunaweza kukusaidia kufanya maamuzi sahihi na kulinda ustawi wako.
Mahusiano ya muamala hutokea wakati mtu mmoja anatoa pesa, zawadi, usaidizi wa kimwili, au manufaa mengine huku akitarajia uhusiano wa kimapenzi au wa kimapenzi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `These relationships often involve unequal power, making it difficult for the other person to freely make decisions or say "no."`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mahusiano haya mara nyingi huhusisha nguvu zisizo sawa, na kufanya iwe vigumu kwa mtu mwingine kufanya maamuzi kwa uhuru au kusema "hapana."`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Some young people may find themselves in these situations because of challenges such as:
    ● Poverty.
    ● School-related expenses.
    ● Peer pressure.
    ● The desire for status items.
    ● Lack of support.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Baadhi ya vijana wanaweza kujikuta katika hali hizi kwa sababu ya changamoto kama vile:
    ● Umaskini.
    ● Gharama zinazohusiana na shule.
    ● Shinikizo la rika.
    ● Hamu ya vitu vya hadhi.
    ● Ukosefu wa usaidizi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `It's important to remember that needing financial or material support is never something to be ashamed of.
However, no one should ever feel pressured to exchange affection or sexual activity for money, gifts, or other benefits.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ni muhimu kukumbuka kwamba kuhitaji usaidizi wa kifedha au kimwili si jambo la kuaibika kamwe.
Hata hivyo, hakuna mtu anayepaswa kuhisi kushinikizwa kubadilishana mapenzi au shughuli za ngono kwa pesa, zawadi, au manufaa mengine.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Transactional relationships can expose young people to several risks, including:
    ● Sexual exploitation.
    ● Unintended pregnancy.
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mahusiano ya muamala yanaweza kuwaweka vijana katika hatari kadhaa, ikiwa ni pamoja na:
    ● Unyonyaji wa kingono.
    ● Mimba zisizotarajiwa.
    ● Maambukizi ya zinaa (STI), ikiwa ni pamoja na VVU.
    ● Madhara ya kihisia.
    ● Kuacha shule.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For example, an older person may regularly buy a student clothes, airtime, transportation, or meals and then expect sexual activity in return.
This may be a form of exploitation because it involves a power imbalance rather than a healthy, equal relationship.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kwa mfano, mtu mzee anaweza kumnunulia mwanafunzi nguo, muda wa maongezi, usafiri, au milo mara kwa mara na kisha kutarajia shughuli za kingono kwa malipo.
Hii inaweza kuwa aina ya unyonyaji kwa sababu inahusisha usawa wa madaraka badala ya uhusiano mzuri na sawa.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_07',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Remember, receiving help or support should never come with the expectation of providing sexual activity or entering a romantic relationship in return.
Healthy relationships are built on mutual respect, free choice, trust, and consent-not on pressure, fear, or the exchange of gifts or money.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kumbuka, kupokea msaada au usaidizi haipaswi kuja na matarajio ya kutoa shughuli za ngono au kuingia katika uhusiano wa kimapenzi kama malipo.
Mahusiano mazuri hujengwa juu ya heshima ya pande zote, chaguo huru, uaminifu, na ridhaa-sio juu ya shinikizo, hofu, au kubadilishana zawadi au pesa.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_08',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you ever feel pressured into a relationship because of money, gifts, or other support, it's important to talk to a trusted adult, teacher, parent, guardian, school counselor, healthcare provider, or another trusted person.
You deserve relationships where you feel respected, safe, and able to make your own choices.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ukiwahi kuhisi kushinikizwa kuingia katika uhusiano kwa sababu ya pesa, zawadi, au usaidizi mwingine, ni muhimu kuzungumza na mtu mzima unayemwamini, mwalimu, mzazi, mlezi, mshauri wa shule, mtoa huduma ya afya, au mtu mwingine unayemwamini.
Unastahili mahusiano ambapo unahisi unaheshimiwa, salama, na unaweza kufanya maamuzi yako mwenyewe.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_09',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Would you like to learn more about healthy relationships, consent, recognizing exploitation, or where to seek help if someone is pressuring you? I'm here to support you.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Je, ungependa kujifunza zaidi kuhusu mahusiano mazuri, ridhaa, kutambua unyonyaji, au wapi pa kutafuta msaada ikiwa mtu anakushinikiza? Niko hapa kukusaidia.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you need health information, HIV testing, family planning services, pregnancy-related care, mental health support, protection from violence or help with abuse, you do not have to face it alone.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Exchange relationships - be careful.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mahusiano ya kubadilishana vitu - tahadhari.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `● Transactional relationships occur when one person gives money or goods in exchange for love or sex.
● These often involve unequal power and can lead to exploitation, pregnancy, or disease.
● Receiving help should never require sex in return - ever.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `● Mahusiano ya miamala hutokea mtu mmoja anapotoa fedha au vitu akitarajia mapenzi au ngono kama malipo.
● Haya mara nyingi huwa na nguvu zisizo sawa na yanaweza kusababisha unyonyaji, mimba, au magonjwa.
● Kupokea msaada hakupaswi kuhitaji ngono kama malipo - kamwe.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'TRANSACTIONAL_RELATIONSHIPS',
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Are you in a relationship that makes you feel this way? Tell us, we're here without judgment.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Uko kwenye uhusiano unaokufanya uhisi hivi? Tuambie, tuko hapa bila hukumu.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
...
Unyanyasaji unaweza kufanywa na watu wanaomjua mwathiriwa. Kuripoti bado ni muhimu.`,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'REPORTING_ABUSE_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'REPORTING_ABUSE_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'REPORTING_ABUSE_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'REPORTING_ABUSE_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
● Ripoti kwa polisi, afisa ustawi wa jamii, au uongozi wa shule - hata kama mkosaji ni mtu unayemfahamu.`,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'GENDER_EQUALITY_FEEDBACK_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'REPORTING_ABUSE',
      nodeKey: 'GENDER_EQUALITY_FEEDBACK_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
https://forms.gle/8NNWF11TKatfBoH4A`,
  ...
  contentNodeOptions: [
    ...
    {
      nodeKey: 'CHILDS_MARRIAGE_01',
      optionValue: 'under_18',
      labelEn: 'Why it happens?',
      labelSw: 'Kwanini hutokea?',
    ...
    {
      nodeKey: 'CHILDS_MARRIAGE_02',
      optionValue: 'girls_risks',
      labelEn: 'Girls risks',
      labelSw: 'Hatari kwa binti',
      nextNodeKey: 'CHILDS_MARRIAGE_04',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Key reminder',
      labelSw: 'Kumbusho muhimu',
      nextNodeKey: 'CHILDS_MARRIAGE_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CHILDS_MARRIAGE_04',
      optionValue: 'not_solution',
      labelEn: 'Another reminder',
      labelSw: 'Kumbusho nyingine',
      nextNodeKey: 'CHILDS_MARRIAGE_06',
      sortOrder: 2,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get help',
      labelSw: 'Pata msaada',
      nextNodeKey: 'CHILDS_MARRIAGE_09',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CHILDS_MARRIAGE_05',
      optionValue: 'if_forced',
      labelEn: 'If forced?',
      labelSw: 'Ukilazimishwa?',
      nextNodeKey: 'CHILDS_MARRIAGE_07',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Anything else?',
      labelSw: 'Kuna lingine?',
      nextNodeKey: 'CHILDS_MARRIAGE_08',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      optionValue: 'gender_equality',
      labelEn: 'Gender equality',
      labelSw: 'Usawa wa kijinsia',
      nextNodeKey: 'UNDERSTANDING_GENDER_01',
      sortOrder: 2,
      isActive: true,
    },
    {
      ...
      labelEn: 'Test yourself',
      labelSw: 'Jipime',
      nextNodeKey: 'CHILDS_MARRIAGE_REFRESHER_01',
      sortOrder: 3,
      isActive: true,
    },

    {
      ...
      labelEn: 'Start refresher',
      labelSw: 'Anza kujikumbusha',
      nextNodeKey: 'CHILDS_MARRIAGE_REFRESHER_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get help now',
      labelSw: 'Pata msaada sasa',
      nextNodeKey: 'CHILDS_MARRIAGE_REFRESHER_03',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Get help',
      labelSw: 'Pata msaada',
      nextNodeKey: 'SEXUAL_EXPLOITATION_10',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'The Harm',
      labelSw: 'Madhara yake',
      nextNodeKey: 'SEXUAL_EXPLOITATION_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'SEXUAL_EXPLOITATION_03',
      optionValue: 'hard_to_spot',
      labelEn: 'Hard to spot?',
      labelSw: 'Ni vigumu kuona?',
    ...
    {
      nodeKey: 'SEXUAL_EXPLOITATION_04',
      optionValue: 'no_exchange',
      labelEn: 'No exchange?',
      labelSw: 'Si kubadilishana?',
      nextNodeKey: 'SEXUAL_EXPLOITATION_06',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'SEXUAL_EXPLOITATION_05',
      optionValue: 'pressured',
      labelEn: 'Feeling pressured?',
      labelSw: 'Unashinikizwa?',
      nextNodeKey: 'SEXUAL_EXPLOITATION_07',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'SEXUAL_EXPLOITATION_06',
      optionValue: 'if_happening',
      labelEn: 'If it happens?',
      labelSw: 'Ikitokea?',
      nextNodeKey: 'SEXUAL_EXPLOITATION_08',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Anything else?',
      labelSw: 'Kuna lingine?',
      nextNodeKey: 'SEXUAL_EXPLOITATION_09',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Test yourself',
      labelSw: 'Jipime',
      nextNodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_01',
      sortOrder: 3,
      isActive: true,
    },

    {
      ...
      labelEn: 'Start refresher',
      labelSw: 'Anza kujikumbusha',
      nextNodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get help now',
      labelSw: 'Pata msaada sasa',
      nextNodeKey: 'SEXUAL_EXPLOITATION_REFRESHER_03',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_01',
      optionValue: 'why_happens',
      labelEn: 'Why it happens?',
      labelSw: 'Hutokea kwa nini?',
    ...
    },
    {
      ...
      labelEn: 'The Risks',
      labelSw: 'Hatari zake',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_05',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Example',
      labelSw: 'Mfano',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_06',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Get help',
      labelSw: 'Pata msaada',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Key reminder',
      labelSw: 'Kumbusho muhimu',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_07',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'TRANSACTIONAL_RELATIONSHIPS_06',
      optionValue: 'if_pressured',
      labelEn: 'If pressured?',
      labelSw: 'Ukishinikizwa?',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_08',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Anything else?',
      labelSw: 'Kuna lingine?',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_09',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Test yourself',
      labelSw: 'Jipime',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_01',
      sortOrder: 3,
      isActive: true,
    },

    {
      ...
      labelEn: 'Start refresher',
      labelSw: 'Anza kujikumbusha',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get help now',
      labelSw: 'Pata msaada sasa',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_REFRESHER_03',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'UNDERSTANDING_GENDER_08_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'UNDERSTANDING_GENDER_08_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'UNDERSTANDING_GENDER_08_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'UNDERSTANDING_GENDER_08_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'GENDER_ROLES_AND_STEREOTYPES_12_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'TYPES_OF_VIOLENCE_17_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'TYPES_OF_VIOLENCE_17_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'TYPES_OF_VIOLENCE_17_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'TYPES_OF_VIOLENCE_17_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'CHILDRENS_RIGHTS_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'CHILDRENS_RIGHTS_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'CHILDRENS_RIGHTS_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'CHILDRENS_RIGHTS_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'ADOLESCENTS_RIGHTS_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'ADOLESCENTS_RIGHTS_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'ADOLESCENTS_RIGHTS_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'ADOLESCENTS_RIGHTS_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'PROTECTION_FROM_ABUSE_09_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'PROTECTION_FROM_ABUSE_09_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'PROTECTION_FROM_ABUSE_09_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'PROTECTION_FROM_ABUSE_09_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'CHILDS_MARRIAGE_09_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'CHILDS_MARRIAGE_09_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'CHILDS_MARRIAGE_09_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'CHILDS_MARRIAGE_09_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'SEXUAL_EXPLOITATION_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'SEXUAL_EXPLOITATION_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'SEXUAL_EXPLOITATION_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'SEXUAL_EXPLOITATION_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'TRANSACTIONAL_RELATIONSHIPS_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'REPORTING_ABUSE_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'REPORTING_ABUSE_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'REPORTING_ABUSE_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'REPORTING_ABUSE_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      nextNodeKey: 'GENDER_EQUALITY_FEEDBACK_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Yes',
      labelSw: 'Ndiyo',
      nextNodeKey: 'GENDER_EQUALITY_FEEDBACK_02',
      sortOrder: 1,
      isActive: true,
    },
    {
