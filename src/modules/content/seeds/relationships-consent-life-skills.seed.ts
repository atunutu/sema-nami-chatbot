...
`,
    ...
    {
      subtopicCode: 'UNDERSTANDING_CONSENT',
      nodeKey: 'UNDERSTANDING_CONSENT_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'UNDERSTANDING_CONSENT',
      nodeKey: 'UNDERSTANDING_CONSENT_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'UNDERSTANDING_CONSENT',
      nodeKey: 'UNDERSTANDING_CONSENT_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'UNDERSTANDING_CONSENT',
      nodeKey: 'UNDERSTANDING_CONSENT_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
`,
    ...
    {
      subtopicCode: 'RESPECT_AND_BOUNDARIES',
      nodeKey: 'RESPECT_AND_BOUNDARIES_09_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'RESPECT_AND_BOUNDARIES',
      nodeKey: 'RESPECT_AND_BOUNDARIES_09_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'RESPECT_AND_BOUNDARIES',
      nodeKey: 'RESPECT_AND_BOUNDARIES_09_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'RESPECT_AND_BOUNDARIES',
      nodeKey: 'RESPECT_AND_BOUNDARIES_09_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'COMMUNICATION_SKILLS',
      nodeKey: 'COMMUNICATION_SKILLS_10_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'COMMUNICATION_SKILLS',
      nodeKey: 'COMMUNICATION_SKILLS_10_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'COMMUNICATION_SKILLS',
      nodeKey: 'COMMUNICATION_SKILLS_10_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'COMMUNICATION_SKILLS',
      nodeKey: 'COMMUNICATION_SKILLS_10_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'DECISION_MAKING_SKILLS',
      nodeKey: 'DECISION_MAKING_SKILLS_08_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'DECISION_MAKING_SKILLS',
      nodeKey: 'DECISION_MAKING_SKILLS_08_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'DECISION_MAKING_SKILLS',
      nodeKey: 'DECISION_MAKING_SKILLS_08_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'DECISION_MAKING_SKILLS',
      nodeKey: 'DECISION_MAKING_SKILLS_08_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'NEGOTIATION_SKILLS',
      nodeKey: 'NEGOTIATION_SKILLS_08_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'NEGOTIATION_SKILLS',
      nodeKey: 'NEGOTIATION_SKILLS_08_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'NEGOTIATION_SKILLS',
      nodeKey: 'NEGOTIATION_SKILLS_08_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'NEGOTIATION_SKILLS',
      nodeKey: 'NEGOTIATION_SKILLS_08_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'PEER_PRESSURE',
      nodeKey: 'PEER_PRESSURE_04_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'PEER_PRESSURE',
      nodeKey: 'PEER_PRESSURE_04_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'PEER_PRESSURE',
      nodeKey: 'PEER_PRESSURE_04_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'PEER_PRESSURE',
      nodeKey: 'PEER_PRESSURE_04_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'REFUSING_UNWANTED_SEXUAL_PRESSURE',
      nodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'REFUSING_UNWANTED_SEXUAL_PRESSURE',
      nodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'REFUSING_UNWANTED_SEXUAL_PRESSURE',
      nodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'REFUSING_UNWANTED_SEXUAL_PRESSURE',
      nodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
`,
    ...
    {
      subtopicCode: 'GOAL_SETTING_AND_FUTURE_PLANNING',
      nodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'GOAL_SETTING_AND_FUTURE_PLANNING',
      nodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'GOAL_SETTING_AND_FUTURE_PLANNING',
      nodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'GOAL_SETTING_AND_FUTURE_PLANNING',
      nodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
Vijana (wasichana na wavulana) wanaojitambua watatafuta elimu ya afya ya uzazi, watajilinda na maambukizi ya maradhi ya ngono ikiwemo VVU/UKIMWI.`,
    ...
    {
      subtopicCode: 'SELF_IDENTIFICATION',
      nodeKey: 'SELF_IDENTIFICATION_18_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance. You may also speak to a trusted parent, guardian, teacher, counsellor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SELF_IDENTIFICATION',
      nodeKey: 'SELF_IDENTIFICATION_18_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'SELF_IDENTIFICATION',
      nodeKey: 'SELF_IDENTIFICATION_18_OVAH_CONTACT_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'SELF_IDENTIFICATION',
      nodeKey: 'SELF_IDENTIFICATION_18_END_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Thank you for learning with Sema Nami.`,
      inputType: InputType.BUTTON,
...
Sahihi: B - Uongo. Kujitambua ni kutambua thamani yako, si kudharau wengine.`,
    ...
    {
      subtopicCode: 'HEALTHY_RELATIONSHIPS',
      nodeKey: 'RELATIONSHIPS_FEEDBACK_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'HEALTHY_RELATIONSHIPS',
      nodeKey: 'RELATIONSHIPS_FEEDBACK_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
https://forms.gle/8NNWF11TKatfBoH4A`,
  ...
  contentNodeOptions: [
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'UNDERSTANDING_CONSENT_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'UNDERSTANDING_CONSENT_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'UNDERSTANDING_CONSENT_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'UNDERSTANDING_CONSENT_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'RESPECT_AND_BOUNDARIES_09_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'RESPECT_AND_BOUNDARIES_09_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'RESPECT_AND_BOUNDARIES_09_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'RESPECT_AND_BOUNDARIES_09_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'COMMUNICATION_SKILLS_10_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'COMMUNICATION_SKILLS_10_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'COMMUNICATION_SKILLS_10_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'COMMUNICATION_SKILLS_10_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'DECISION_MAKING_SKILLS_08_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'DECISION_MAKING_SKILLS_08_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'DECISION_MAKING_SKILLS_08_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'DECISION_MAKING_SKILLS_08_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'NEGOTIATION_SKILLS_08_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'NEGOTIATION_SKILLS_08_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'NEGOTIATION_SKILLS_08_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'NEGOTIATION_SKILLS_08_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'PEER_PRESSURE_04_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'PEER_PRESSURE_04_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'PEER_PRESSURE_04_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'PEER_PRESSURE_04_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'REFUSING_UNWANTED_SEXUAL_PRESSURE_08_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'GOAL_SETTING_AND_FUTURE_PLANNING_07_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'SELF_IDENTIFICATION_18_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'SELF_IDENTIFICATION_18_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'SELF_IDENTIFICATION_18_OVAH_CONTACT_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'End',
      labelSw: 'Maliza',
      nextNodeKey: 'SELF_IDENTIFICATION_18_END_01',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      nextNodeKey: 'RELATIONSHIPS_FEEDBACK_01',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Yes',
      labelSw: 'Ndiyo',
      nextNodeKey: 'RELATIONSHIPS_FEEDBACK_02',
      sortOrder: 1,
      isActive: true,
    },
    {
