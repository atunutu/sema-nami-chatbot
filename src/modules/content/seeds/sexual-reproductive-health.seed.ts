...
export const sexualReproductiveHealthSeed = {
  ...
  subtopics: [
    ...
    },
    {
      ...
      titleEn: 'Teen Pregnancy',
      titleSw: 'Ujauzito wa Utotoni',
      descriptionEn: null,
      descriptionSw: null,
      audienceGender: null,
      ageBandRule: null,
    ...
    },
    {
      ...
      titleEn: 'Needs during pregnancy',
      titleSw: 'Mahitaji mda wa ujauzito',
      descriptionEn: null,
      descriptionSw: null,
      audienceGender: null,
      ageBandRule: null,
    ...
    },
    {
      ...
      titleEn: 'Adolescents w/ Disability',
      titleSw: 'Vijana wenye ulemavu',
      descriptionEn: null,
      descriptionSw: null,
      audienceGender: null,
      ageBandRule: null,
  ...
  contentNodes: [
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_REFERRAL_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_REFERRAL_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_REFERRAL_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `This is why, the community, government and other stakeholder are advocating for adolescents girls to staying in school, ensure they can access to SRHR information and youth friendly health services have positive peer networks and supportive families.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Hii ndiyo sababu, jamii, serikali na wadau wengine wanatetea wasichana vijana kuendelea na shule, kuhakikisha wanaweza kupata taarifa za SRHR na huduma za afya rafiki kwa vijana kuwa na mitandao chanya ya wenzao na familia zinazounga mkono.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `During this process pregnant women are encouraged to identify a health facility near them and save emergency contacts, prepare transportation in advance and attend scheduled clinic visits.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Wakati wa mchakato huu wanawake wajawazito wanahimizwa kutambua kituo cha afya kilicho karibu nao na kuokoa mawasiliano ya dharura, kuandaa usafiri mapema na kuhudhuria ziara za kliniki zilizopangwa.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
Atapata muda wa kufanya shughuli za kujiingizia kipato na chakula, atafurahia tendo la kujamiiana katika hali ya utulivu. Atapata muda wa kushiriki shughuli za maendeleo.`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Birth control methods are safe to use because they have been thoroughly researched to ensure that they are effective.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Njia za uzazi wa mpango ni salama kutumia kwani zimefanyiwa utafiti wa kina ili kuhakikisha kwamba zinafaa.
Hata hivyo kama zilivyo dawa nyinge zo zote, huweza kutokea kwa wachache kwamba njia hizi zikawapa maudhi madogo madogo ambayo hisha baada muda mfupi.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
Simu/WhatsApp: 0652 522 358`,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Oral pills: These pills come in two types, dual-acting and single-acting. These pills are used only by women. These methods are available at reproductive health clinics.

Oral pills do not prevent a person from getting sexually transmitted infections (STIs).`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Vidonge vya kumeza: Vidonge hivyo vipo vya aina mbili, zenye vichocheo viwili na vyenye kichocheo kimoja. Vidonge hivyo hutumika na wanawake tu. Njia hizi zinapatikana kliniki za afya ya uzazi na mtoto.

Vidonge vya kumeza havimzuii mtu kupata maambukizi ya magonjwa yanayotokana na ngono (kujamiiana).`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Emergency contraception: This method is used in case of emergency sexual intercourse without using a contraceptive method and thus there is a concern about getting pregnant.

This method is used by women and it is advisable to go to a health care provider for them. This emergency method does not prevent the transmission of sexually transmitted infections.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Njia ya dharura ya kuzuia mimba: Njia hii hutumika endapo kuna dharura ya kujamiiana bila kutumia njia ya uzazi wa mpango na hivyo kuwa na wasiwasi wa kupata mimba.

Njia hii hutumiwa na wanawake na ni vyema kwenda kuzipata kwa mtoa huduma sehemu ya kutolea huduma za afya. Njia hii ya dharura haizuii maambukizi ya magonjwa yanayotokana na kujamiiana.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Injection method: It is used only by women. It is an injection with only one active ingredient.

It is provided at reproductive health clinics. It does not prevent sexually transmitted infections.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Njia ya sindano: Hutumiwa na wanawake tu. Ni sindano yenye dawa yenye kichocheo kimoja tu.

Hutolewa kwenye kliniki za afya ya uzazi. Haizuii maambukizo yanayoenezwa kwa kujamiiana.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Implants: Also used only by women. Like the injection, it contains only one active ingredient and is available at clinics.
...
It does not prevent sexually transmitted infections.`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Vipandikizi: Pia hutumika na wanawake tu. Kama ilivyo sindano ina dawa yenye kichocheo kimoja tu na hupatikana kliniki.

Haizuii maambukizo ya magonjwa ya ngono.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Rubber condom: It is a rubber made to follow the shape of the penis. It is worn on the erect penis before sexual intercourse.

It is available in clinics, stores and reproductive health providers in the community as well as peer educators in the community. This method prevents sexually transmitted infections, so it is given priority as an appropriate method for adolescents.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kondomu ya mpira: Ni mpira uliotengenezwa kwa kufuata umbile la uume. Huvaliwa kwenye uume uliosimama kabla ya kuanza kujamiiana.

Hupatikana kliniki, madukani na watoa huduma za afya ya uzazi kwa jamii pamoja na waelimishaji rika katika jamii. Njia hii huzuia maambukizi yatokanayo na kujamiiana, hivyo basi hupata kipaumbele kama njia muafaka kwa vijana balehe.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_07',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Female condom: Used by women. Available in clinics and stores.

Like the male condom, it prevents sexually transmitted infections.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kondomu ya kike: Inatumiwa na wanawake. Hupatikana kliniki na madukani.

Kama ilivyo kwa kondom ya kiume, huzuia maambukizi yatokanayo na kujamiiana.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_08',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `NB: For adolescents, even if they use any other method, it is better to use it together with a condom because it is the only way that can help protect them from sexually transmitted diseases.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `NB: Kwa vijana, hata kama anatumia njia nyingine yoyote ni vyema ikatumiwa pamoja na kondomu kwani ni njia pekee inayoweza kusaidia kumkinga na magonjwa ya ngono.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_09',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Note: Birth control methods are safe to use because they have been thoroughly researched to ensure that they are effective.

However, like any other medicine, it may happen to a few that these methods cause minor side effects that disappear after a short time.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kumbuka: Njia za uzazi wa mpango ni salama kutumia kwani zimefanyiwa utafiti wa kina ili kuhakikisha kwamba zinafaa.

Hata hivyo kama zilivyo dawa nyingine zo zote, huweza kutokea kwa wachache kwamba njia hizi zikawapa maudhi madogo madogo ambayo huisha baada ya muda mfupi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you need health information, HIV testing, family planning services, pregnancy-related care, mental health support, protection from violence or help with abuse, you do not have to face it alone.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You may also speak to a trusted parent, guardian, teacher, counselor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'CONTRACEPTIVE_METHODS',
      nodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, you can contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Early detection of teenage pregnancy is important but not easy to detect because teenage girls try to use any possible method to avoid detection.
Some may hide the condition until delivery.
It is important that when pregnancy symptoms appear, the girl has a urine test to confirm pregnancy early.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kutambua mapema mimba ya kijana balehe ni kitu muhimu lakini sio rahisi kutambua kwani vijana balehe hujitahidi kutumia njia yoyote inayowezekana ili wasibainike.
Wengine huweza kuficha hali hiyo mpaka wakati wa kijifungua.
Ni muhimu dalili za ujauzito zinapojitokeza kijana apimwe mkojo ili kuthibitisha mimba mapema.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `After early detection of teenage pregnancy, support should include:
    - Advice on the importance of attending the clinic
    - Getting vaccinated
    - Monitoring the development of pregnancy
    - Checking her health (weight, blood pressure, heart rate and even diseases).
    - Early detection if there is a problem and thus getting early care
    - Getting education and advice about her health and the baby in the womb.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Baada ya kutambua mapema mimba ya kijana balehe, msaada unapaswa kujumuisha:
    - Ushauri kuhusu umuhimu wa kuhudhuria kliniki
    - Kupata chanjo
    - Kuangalia maendeleo ya ukuaji wa mimba
    - Kuangaliwa afya yake (uzito, kiasi cha damu, mapigo ya moyo na hata magonjwa).
    - Kugundulika mapema kama kuna tatizo na hivyo kupata huduma mapema
    - Kupata elimu na ushauri kuhusu afya yake na mtoto alie tumboni.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `The foods needed include
    - Protein category (protein) - Meat, eggs, beans, fish
    - Vitamin category - fruits, leafy vegetables, grains that are not too refined
    - Minerals - Liver, fish, leafy vegetables, seafood

NB: Leafy vegetables should not be boiled for a long time as doing so removes/destroys nutrients.
A pregnant woman should do light exercise like walking especially in the morning and evening.
She should also have plenty of time to rest.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Vyakula vinavyohitajika ni pamoja na
    ...
    - Madini - Maini, samaki, mboga za majani, dagaa

NB: Mboga za majani zisichemshwe muda mrefu kwani kufanya hivyo huondoa/huharibu virutubisho.
Mjamzito anapaswa kufanya mazoezi yasiyo mazito kama kutembea hasa wakati wa asubuhi na jioni. Vile vile anapaswa kuwa na muda mwingi wa kupumzika.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Definition of young person with a disability.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Maana ya kijana mwenye ulemavu ni kijana mwenye udhaifu au upungufu wa viungo, fahamu au akili na ambaye uwezo wake wa utendaji kazi umepungua kutokana na vikwazo vya kimtazamo, kimazingira na kitaasisi.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `The National Youth and Development Policy of 2018 recognizes the importance of meeting the needs of young people, including those with disabilities, which provides a guiding statement to protect, reduce or completely eliminate stigma.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Sera ya Taifa ya Vijana na Maendeleo ya mwaka 2018 inatambua umuhimu wa kutimiza mahitaji ya vijana wakiwemo wenye ulemavu ambayo inatoa tamko elekezi ili kuwalinda, kupunguza au kumaliza kabisa unyanyapaa.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ili kuboresha upatikanaji wa taarifa sahihi na huduma rafiki za Afya ya uzazi kwa vijana wenye ulemavu, ni muhimu kuzingatia kwamba kubadili fikra na mitazamo ndiyo hatua muhimu itakayo badilisha matendo na fikra za wananchi juu ya watu wenye ulemavu katika nyanja zote za maisha kiuchumi, kisiasa na kiutamaduni ili kuwa na jamii jumuishi isiyo na ubaguzi.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Many young people avoid testing because they are afraid of the results or fear being judged. However, HIV testing does not mean someone has HIV. It simply helps a person know their status and receive the appropriate information and support.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Vijana wengi huepuka kupima kwa sababu wanaogopa matokeo au wanaogopa kuhukumiwa. Hata hivyo, upimaji wa VVU haimaanishi kwamba mtu ana VVU. Humsaidia tu mtu kujua hali yake na kupokea taarifa na usaidizi unaofaa.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Tabia ya kutafuta afya inahusu hatua ambazo watu huchukua ili kulinda, kudumisha, au kuboresha afya zao.
Kwa vijana, hii ina maana ya kutambua wanapohitaji taarifa za afya, ushauri, upimaji, matibabu, au usaidizi na kujua wapi na jinsi ya kupata huduma hizi.

Vijana wengi hutembelea kituo cha afya wanapokuwa wagonjwa sana. Hata hivyo, tabia nzuri ya kutafuta afya inajumuisha kutafuta huduma kabla matatizo hayajawa makubwa.
Mifano ni pamoja na kutembelea kituo cha afya kwa ajili ya kupima VVU, taarifa za uzazi wa mpango, uchunguzi wa magonjwa ya zinaa, usaidizi wa afya ya akili, huduma ya ujauzito, chanjo, au ushauri wa kimatibabu wanapopata dalili zisizo za kawaida.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `In Tanzania, some adolescents avoid seeking healthcare because they fear being judged, feel shy, worry about confidentiality, lack transport money, or do not know where services are available. Others rely on friends or social media for health information, which may sometimes be inaccurate. Seeking health information from trained healthcare providers helps young people make informed decisions and receive accurate guidance.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
`,
  ...
  contentNodeOptions: [
    {
      nodeKey: 'CONDOM_USE_01',
      optionValue: 'emergency_contraception',
      labelEn: 'Emergency option',
      labelSw: 'Dharura uzazi',
    ...
    {
      nodeKey: 'CONDOM_USE_01',
      optionValue: 'sti_prevention',
      labelEn: 'STI prevention',
      labelSw: 'Kuzuia magonjwa',
      nextNodeKey: 'SEXUALLY_TRANSMITTED_INFECTIONS_01',
      sortOrder: 2,
      isActive: true,
    },
    {
      nodeKey: 'CONDOM_USE_01',
      optionValue: 'condom_myths',
      labelEn: 'Myths about condoms',
      labelSw: 'Dhana za kondomu',
      nextNodeKey: 'FAMILY_PLANNING_06',
      sortOrder: 3,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get support',
      labelSw: 'Pata msaada',
      nextNodeKey: 'CONDOM_USE_REFERRAL_01',
      sortOrder: 4,
      isActive: true,
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'CONDOM_USE_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'CONDOM_USE_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'CONDOM_USE_REFERRAL_04',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      nextNodeKey: 'CONDOM_USE_REFERRAL_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'REPRODUCTIVE_ANATOMY_01',
      optionValue: 'male_organs',
      labelEn: 'Male Organs',
      labelSw: 'Viungo kiume?',
    ...
    },
    {
      ...
      labelEn: 'How it happens',
      labelSw: 'Hutokeaje?',
      nextNodeKey: 'HUMAN_REPRODUCTION_03',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      nodeKey: 'PREGNANCY_02',
      optionValue: 'facts',
      labelEn: 'Pregnancy facts',
      labelSw: 'Ukweli kuhusu mimba',
      nextNodeKey: 'PREGNANCY_06',
      sortOrder: 2,
      isActive: true,
    },
    ...
    {
      nodeKey: 'MISCARRIAGE_03',
      optionValue: 'planning',
      labelEn: 'Family Planning',
      labelSw: 'Kupanga uzazi',
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_01',
      optionValue: 'oral_pills',
      labelEn: 'Oral pills',
      labelSw: 'Vidonge',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Emergency?',
      labelSw: 'Dharura?',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_03',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_02',
      optionValue: 'injection',
      labelEn: 'Injection',
      labelSw: 'Sindano',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_04',
      sortOrder: 2,
      isActive: true,
    },
    {
      ...
      labelEn: 'Get support',
      labelSw: 'Pata msaada',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_01',
      sortOrder: 3,
      isActive: true,
    },
    {
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_01',
      optionValue: 'after_detection',
      labelEn: 'After detection',
      labelSw: 'Baada ya kubaini',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Best food',
      labelSw: 'Lishe bora',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_02',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      nodeKey: 'HIV_AND_AIDS_01',
      optionValue: 'aids',
      labelEn: 'What is AIDS?',
      labelSw: 'UKIMWI ni nini?',
      nextNodeKey: 'HIV_AND_AIDS_07',
      sortOrder: 1,
      isActive: true,
    },
    {
      nodeKey: 'HIV_AND_AIDS_01',
      optionValue: 'spread',
      labelEn: 'How it spreads',
      labelSw: 'VVU inasambaaje?',
    ...
    },
    {
      nodeKey: 'ADOLESCENTS_WITH_DISABILITY_RIGHTS_SRHR_01',
      optionValue: 'policy',
      labelEn: 'Known policies',
      labelSw: 'Sera zilizopo',
      nextNodeKey: 'ADOLESCENTS_WITH_DISABILITY_RIGHTS_SRHR_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'HIV_TESTING_SERVICES_01',
      optionValue: 'testing_fear',
      labelEn: 'Testing fears',
      labelSw: 'Hofu za kupima',
      nextNodeKey: 'HIV_TESTING_SERVICES_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      nodeKey: 'HIV_TESTING_SERVICES_01',
      optionValue: 'when_test',
      labelEn: 'When should I test?',
      labelSw: 'Nipime lini?',
      nextNodeKey: 'HIV_TESTING_SERVICES_04',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      nextNodeKey: 'CONDOM_EDUCATION_03',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_01',
      optionValue: 'barriers',
      labelEn: 'Common barriers',
      labelSw: 'Vikwazo tofauti',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_01',
      optionValue: 'when_seek',
      labelEn: 'When to seek',
      labelSw: 'Nihudumiwe lini?',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_03',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'ANTENATAL_CARE_03',
      optionValue: 'baby_effects',
      labelEn: 'Effects on the baby',
      labelSw: 'Matatizo Kwa mtoto',
      nextNodeKey: 'ANTENATAL_CARE_06',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_03',
      optionValue: 'implants',
      labelEn: 'Implants',
      labelSw: 'Vipandikizi',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Condoms',
      labelSw: 'Kondomu',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_06',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_05',
      optionValue: 'female_condom',
      labelEn: 'Female condom',
      labelSw: 'Kondomu ya kike',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_07',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_06',
      optionValue: 'condom_note',
      labelEn: 'Condom note',
      labelSw: 'Kumbuka kondomu',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_08',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_07',
      optionValue: 'safety_note',
      labelEn: 'Safety note',
      labelSw: 'Kumbuka usalama',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_09',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Trusted people',
      labelSw: 'Watu wa kuamini',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_04',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'CONTRACEPTIVE_METHODS_REFERRAL_05',
      sortOrder: 2,
      isActive: true,
    },
    {
