...
● Madini - Maini, samaki, mboga za majani, dagaa`,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Support should also include:
...
● Getting education and advice about her health and the baby in the womb`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Msaada unapaswa pia kujumuisha:
...
● Kupata elimu na ushauri kuhusu afya yake na mtoto alie tumboni`,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Leafy vegetables should not be boiled for a long time as doing so removes/destroys nutrients.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mboga za majani zisichemshwe muda mrefu kwani kufanya hivyo huondoa/huharibu virutubisho.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Exercise and rest: A pregnant woman should do light exercise like walking especially in the morning and evening. She should also have plenty of time to rest.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mazoezi na kupumzika: Mjamzito anapaswa kufanya mazoezi yasiyo mazito kama kutembea hasa wakati wa asubuhi na jioni. Vile vile anapaswa kuwa na muda mwingi wa kupumzika.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you need health information, HIV testing, family planning services, pregnancy-related care, mental health support, protection from violence or help with abuse, you do not have to face it alone.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You may also speak to a trusted parent, guardian, teacher, counselor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY',
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, you can contact OVAH through:
...
Simu/WhatsApp: 0652 522 358`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Health seeking behaviour refers to the actions people take to protect, maintain, or improve their health.

For adolescents, this means recognizing when they need health information, advice, testing, treatment, or support and knowing where and how to access these services.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
      isEndNode: false,
...
Kwa vijana, hii ina maana ya kutambua wanapohitaji taarifa za afya, ushauri, upimaji, matibabu, au usaidizi na kujua wapi na jinsi ya kupata huduma hizi.`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `In Tanzania, some adolescents avoid seeking healthcare because they fear being judged, feel shy, worry about confidentiality, lack transport money, or do not know where services are available.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Nchini Tanzania, baadhi ya vijana huepuka kutafuta huduma za afya kwa sababu wanaogopa kuhukumiwa, wanahisi aibu, wana wasiwasi kuhusu usiri, wanakosa pesa za usafiri, au hawajui huduma zinapatikana wapi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `A young person should seek health services if they experience symptoms of illness, suspect pregnancy, want to know their HIV status, have concerns about sexual or reproductive health, experience violence or abuse, struggle with emotional wellbeing, or need health information.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kijana anapaswa kutafuta huduma za afya ikiwa anapata dalili za ugonjwa, anashuku ujauzito, anataka kujua hali yake ya VVU, ana wasiwasi kuhusu afya ya ngono au uzazi, anapata vurugu au unyanyasaji, anapambana na ustawi wa kihisia, au anahitaji taarifa za afya.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Many young people only visit a health facility when they are seriously ill. However, good health seeking behaviour includes seeking services before problems become severe.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Vijana wengi hutembelea kituo cha afya wanapokuwa wagonjwa sana. Hata hivyo, tabia nzuri ya kutafuta afya inajumuisha kutafuta huduma kabla matatizo hayajawa makubwa.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Examples include visiting a health facility for HIV testing, family planning information, STI screening, mental health support, antenatal care, immunization, or medical advice when experiencing unusual symptoms.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mifano ni pamoja na kutembelea kituo cha afya kwa ajili ya kupima VVU, taarifa za uzazi wa mpango, uchunguzi wa magonjwa ya zinaa, usaidizi wa afya ya akili, huduma ya ujauzito, chanjo, au ushauri wa kimatibabu wanapopata dalili zisizo za kawaida.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_06',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Others rely on friends or social media for health information, which may sometimes be inaccurate. Seeking health information from trained healthcare providers helps young people make informed decisions and receive accurate guidance.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Wengine hutegemea marafiki au mitandao ya kijamii kwa taarifa za afya, ambazo wakati mwingine zinaweza kuwa si sahihi. Kutafuta taarifa za afya kutoka kwa watoa huduma za afya waliofunzwa huwasaidia vijana kufanya maamuzi sahihi na kupata mwongozo sahihi.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_07',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Early help-seeking can prevent complications and improve overall wellbeing. Seeking healthcare is not a sign of weakness; it is a responsible step toward protecting one's health and future.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kutafuta msaada mapema kunaweza kuzuia matatizo na kuboresha ustawi wa jumla. Kutafuta huduma ya afya si ishara ya udhaifu; ni hatua inayowajibika katika kulinda afya na mustakabali wa mtu.`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: false,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_01',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you need health information, HIV testing, family planning services, pregnancy-related care, mental health support, protection from violence or help with abuse, you do not have to face it alone.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_02',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You can visit the nearest hospital, health centre, dispensary or youth-friendly health service for confidential support and guidance.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_03',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `You may also speak to a trusted parent, guardian, teacher, counselor, social welfare officer, religious leader or healthcare provider.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_04',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `If you are experiencing violence, abuse, exploitation, neglect, forced marriage, sexual harassment or any situation that makes you feel unsafe, seek help immediately from a trusted adult or the relevant authorities.`,
      inputType: InputType.BUTTON,
    ...
    {
      subtopicCode: 'HEALTH_SEEKING_BEHAVIOUR',
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_05',
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `For additional support, guidance or referrals, you can contact OVAH through:
...
https://forms.gle/8NNWF11TKatfBoH4A`,
  ...
  contentNodeOptions: [
    ...
    },
    {
      ...
      labelEn: 'Pregnancy support',
      labelSw: 'Msaada ujauzito',
    ...
    },
    {
      ...
      labelEn: 'Get support',
      labelSw: 'Pata msaada',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_01',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_01',
      optionValue: 'seek_early',
      labelEn: 'Seek early',
      labelSw: 'Tafuta mapema',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_04',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Examples',
      labelSw: 'Mifano',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_02',
      optionValue: 'trusted_info',
      labelEn: 'Trusted info',
      labelSw: 'Taarifa sahihi',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_06',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Get support',
      labelSw: 'Pata msaada',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_01',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_03',
      optionValue: 'health_checks',
      labelEn: 'Health checks',
      labelSw: 'Ukaguzi afya',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_04',
      sortOrder: 1,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_02',
      optionValue: 'food_safety',
      labelEn: 'Food safety',
      labelSw: 'Usalama chakula',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_05',
      sortOrder: 1,
      isActive: true,
    },
    {
      nodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_02',
      optionValue: 'exercise_rest',
      labelEn: 'Exercise/rest',
      labelSw: 'Mazoezi/pumziko',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_06',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Trusted people',
      labelSw: 'Watu wa kuamini',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_04',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'ADOLESCENTS_NEEDS_DURING_PREGNANCY_REFERRAL_05',
      sortOrder: 2,
      isActive: true,
    },
    {
    ...
    {
      nodeKey: 'HEALTH_SEEKING_BEHAVIOUR_03',
      optionValue: 'responsible_step',
      labelEn: 'Responsible step',
      labelSw: 'Hatua sahihi',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_07',
      sortOrder: 3,
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      labelEn: 'Where to go',
      labelSw: 'Niende wapi?',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_02',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Trusted people',
      labelSw: 'Watu wa kuamini',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_03',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'Safety support',
      labelSw: 'Msaada usalama',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_04',
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      labelEn: 'OVAH contact',
      labelSw: 'Mawasiliano OVAH',
      nextNodeKey: 'HEALTH_SEEKING_BEHAVIOUR_REFERRAL_05',
      sortOrder: 2,
      isActive: true,
    },
    {
