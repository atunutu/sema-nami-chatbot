...
`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `More contraceptive methods that can be used by adolescents
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Njia nyingine za uzazi wa mpango zinazoweza kutumiwa na vijana balehe
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Female condom: Used by women. Available in clinics and stores. Like the male condom, it prevents sexually transmitted infections.

NB: For adolescents, even if they use any other method, it is better to use any other method, it is better to use it together with a condom because it is the only way that can help protect them from sexually transmitted diseases.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Kondomu ya kike: Inatumiwa na wanawake. Hupatikana kliniki na madukani. Kama ilivyo kwa kondom ya kiume, huzuia maambukizi yatokanayo na kujamiiana.

NB: Kwa vijana, hata kama anatumia njia nyingine yoyote ni vyema akatumia njia nyingine yoyote ni vyema ikatumiwa pamoja na kondom kwani ni njia pekee inayoweza kusaidi kumkinga na magonjwa ya ngono.
...
`,
  ...
  contentNodeOptions: [
    ...
    {
      nodeKey: 'CONTRACEPTIVE_METHODS_01',
      optionValue: 'more_methods',
      labelEn: 'More methods?',
      labelSw: 'Njia zaidi?',
