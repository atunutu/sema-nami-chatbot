...
export const sexualReproductiveHealthSeed = {
  ...
  contentNodes: [
    ...
    {
      subtopicCode: 'CONDOM_USE',
      nodeKey: 'CONDOM_USE_02',
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.EN,
      messageText: `Emergency Contraception; STI Prevention; Myths About Condoms`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.SW,
      messageText: `Uzazi wa Mpango wa Dharura; Kuzuia Magonjwa ya Ngono; Dhana Potofu Kuhusu Kondomu`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
      isEndNode: true,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Reproductive anatomy refers to the body parts involved in human reproduction. These organs help the body develop during puberty and play important roles in fertility, menstruation, pregnancy, and sexual health.Every person is unique, and reproductive organs may vary slightly in size, shape, and appearance. These differences are usually normal.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mfumo wa uzazi ni mkusanyiko wa viungo vya mwili vinavyohusika katika uzazi wa binadamu. Viungo hivi vina jukumu muhimu katika balehe, hedhi, utungaji wa mimba na afya ya uzazi.Miili ya binadamu wote hutofautiana. Tofauti ndogo katika ukubwa au muonekano wa viungo vya uzazi mara nyingi ni jambo la kawaida.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
• Can pregnancy occur if ejaculation happens near the vagina?`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.SW,
      messageText: `• Mimba haiwezi kutungwa bila urutubishaji.
...
• Mimba inaweza kutokea hata mara ya kwanza kufanya ngono.`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Pregnancy is the period during which a baby develops inside a woman's uterus (womb). Pregnancy begins when a fertilized egg implants in the uterus and normally lasts about 40 weeks (9 months).Pregnancy is a natural biological process, but it also brings physical, emotional, social, and economic changes.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Mimba ni kipindi ambacho mtoto hukua ndani ya mfuko wa uzazi wa mwanamke (tumbo). Mimba huanza wakati yai lililorutubishwa linapopandikizwa kwenye mfuko wa uzazi na kwa kawaida hudumu kwa takriban wiki 40 (miezi 9). Mimba ni mchakato wa asili wa kibiolojia, lakini pia huleta mabadiliko ya kimwili, kihisia, kijamii, na kiuchumi.
      `,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
2. Abortion It is a pregnancy that ends after being induced/provoked such as by intentionally ingesting drugs, inserting sticks or sharp instruments into the cervix. Abortion can also be performed if there is a reason and a doctor's advice (when it threatens life)
...
2. Mimba iliyotolewa Ni kutoka kwa mimba baada ya kuchokonolewa/kuchokozwa kama kwa kumeza dawa kwa kudhamiria, kuingiza vijiti au vyombo vyenye ncha kali kwenye shingo ya mji wa mimba. Pia mimba huweza kutolewa kama kuna sababu na ushauri wa daktari (inapotishia uhai) 
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
3.Kutumia njia ya uzazi wa mpango za dharura `,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.EN,
      messageText: `INFORMATION TO BE GIVEN TO A YOUNG MAN WHO HAS A MISSED PREGNANCY
• This service is available at health facilities.
• It is provided by a qualified service provider
• It is the right of the young man
...
• Usuri (VVF na RVF)`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Family planning is the voluntary decision of an individual or a person and a partner about when to have children, how many children according to their capabilities and needs, and how often to space them (so that it is not less than two years) using the family planning methods of their choice. In accordance with the national family planning policy and guidelines, any person who is capable of causing or becoming pregnant has the right to access family planning services.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Uzazi wa mpango ni uamuzi wa hiari wa mtu binafsi au mtu na mwenza wa lini wazae, watoto wangapi kufuatana na uwezo na mahitaji yao, na watoto wapishane muda gani (ili mradi isiwe chini ya miaka miwili) kwa kutumia njia za uzazi wa mpango walizochaguliwa. Kufuata Na na sera na mwongozo wa taifa wa uzazi wa mpango, mtu yeyote mwenye uwezo wa kusababisha au kupata mimba ana haki ya kupata huduma za uzazi wa mpango. 
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
• Family planning reduces unintended pregnancies, maternal and child mortality and miscarriages.`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.SW,
      messageText: `Kijana balehe ambaye anakiri kuanza kujamiiana ana haki sawa na watu wengine kupata huduma hizi. SABABU/UMUHIMU WA UZAZI WA MPANGO: 
...
• Uzazi wa mpango unapunguza mimba zisizotarajiwa, vifo vya akina mama na watoto na kuharibika mimba.`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.EN,
      messageText: `Uncontrolled population growth can affect economic and social development at the national, community and even household levels. If uncontrolled growth is not controlled, planned plans will not be able to meet people's needs such as housing, health care, shelter, land, environmental protection, food and even employment.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: false,
...
Birth control methods are safe to use because they have been thoroughly researched to ensure that they are effective. However, as with any medicine, it can happen to a few that these methods cause minor side effects that disappear after a short time.
...
`,
    ...
    // HIV and AIDS
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `HIV AND AIDS Human immunodeficiency virus (HIV) is a microscopic virus that is invisible to the naked eye, which attacks and weakens the immune system. The HIV virus lives in the blood and body fluids of an infected person. The virus can infect another person through bodily fluids, especially blood, semen and vaginal fluids. AIDS is a stage in which the body's immune system has been weakened by HIV infection. At this stage, the body becomes vulnerable to opportunistic infections if the patient does not take antiretroviral drugs.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Disability is a state of lack and failure to have the opportunity to participate in normal social life on an equal basis with others due to physical, mental or social reasons. Definition of “Young person with a disability”. A young person with a weakness or impairment of the limbs, consciousness or mind and whose functional capacity is reduced due to attitudinal, environmental and institutional barriers.
The National Youth and Development Policy of 2018 recognizes the importance of meeting the needs of young people, including those with disabilities, which provides a guiding statement to protect, reduce or completely eliminate stigma. This policy also promotes the participation of young people with disabilities in social and economic activities in an enabling environment and in existing opportunities.
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Ulemavu Ni hali ya kukosa na kushindwa kuwa na fursa ya kushiriki katika maisha ya kawaida ya kijamii kwa kiwango sawa na wengine kwa sababu za kimaumbile, kiakili au sababu za kijamii Maana ya “Kijana mwenye ulemavu”. Ni kijana mwenye udhaifu au upungufu wa viungo, fahamu au akili na ambaye uwezo wake wa utendaji kazi umepungua kutokana na vikwazo vya kimtazamo, kimazingira na kitaasisi. 
Sera ya Taifa ya Vijana na Maendeleo ya mwaka 2018 inatambua umuhimu wa kutimiza mahitaji ya vijana wakiwemo wenye ulemavu ambayo inatoa tamko elekezi ili kuwalinda, kupunguza au kumaliza kabisa unyanyapaa. Sera hii pia inachagiza ushiriki wa vijana wenye ulemavu katika shughuli za kijamii na kiuchumi katika hali wezeshi ya kimazingira kwenye fursa zilizopo. 
`,
      inputType: InputType.BUTTON,
      mediaAssetKey: null,
      isStartNode: true,
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.EN,
      messageText: `Rights of young people with disabilities Young people with disabilities have the same rights as other people without disabilities. They have the right to receive special and specialized medical services, as well as equal opportunities for education and training to help them achieve their goals in life. People with disabilities have the right to participate in sports and not to be excluded. Other rights include the right to life, to be respected and valued, to be free from discrimination, to have a name and nationality, to live with one's parents, to express opinions, ideas and decisions regarding one's well-being. to be protected from any form of violence and humiliation.
To improve access to accurate information and friendly reproductive health services for young people with disabilities, it is important to consider that changing mindsets and attitudes is the key step that will change the actions and thoughts of citizens towards people with disabilities in all aspects of economic, political and cultural life in order to have an inclusive society free from discrimination.`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.SW,
      messageText: `Haki za vijana wenye ulemavu Vijana wenye ulemavu wana haki sawa na watu wengine wasio na ulemavu. Wana haki ya kupata huduma za kipekee na maalum zinazohusu matibabu, pamoja na kupata nafasi sawa ya elimu na mazoezi ili kuwasaidia kufikia malengo yao katika maisha. Watu wenye ulemavu wana haki ya kushiriki katika michezo na pia kutokutengwa. Haki nyinginezo ni pamoja na haki ya kuishi ,kuheshimiwa na kuthaminiwa ,kutokubaguliwa ,jina na utaifa ,kuishi na wazazi wake ,kutoa maoni, mawazo na maamuzi kuhusiana na ustawi wake. kulindwa dhidi ya ukatili na udhalilishwaji wa aina yoyote ile. 
...
`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `Sexually transmitted diseases are those that are spread through unprotected sex with an infected person. The relationship between sexually transmitted diseases and HIV H
The transmission route is largely similar, a person with sexually transmitted diseases has a high chance of getting HIV infection during sexual intercourse, and the methods of protection are also similar
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Magonjwa ya ngono ni yale yaenezwayo kwa njia ya kujamiiana na mtu mwenye maambukizi ya magonjwa hayo bila kutumia kinga. Uhusiano kati ya magonjwa ya ngono na VVU H
Njia ya uambukizo inashabihiana kwa kiasi kikubwa mtu mwenye magonjwa ya ngono anauwezekano mkubwa wa kupata maambukizi ya VVU wakati wa kujamiiana pia njia za kujikinga zinafanana 
...
`,
...

    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.EN,
      messageText: `HIV Testing Services (HTS) help individuals know their HIV status through confidential testing and counseling provided by trained healthcare workers. Knowing your HIV status is one of the most important steps in protecting your health and preventing HIV transmission.

Many young people avoid testing because they are afraid of the results or fear being judged. However, HIV testing does not mean someone has HIV. It simply helps a person know their status and receive the appropriate information and support. If the test is negative, healthcare providers can offer guidance on how to remain HIV negative. If the test is positive, early treatment allows people living with HIV to live long, healthy, and productive lives. HIV testing services are available in health facilities throughout Tanzania and are confidential.
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.CONTENT,
      language: Language.SW,
      messageText: `Huduma za Kupima VVU (HTS) huwasaidia watu kujua hali yao ya VVU kupitia upimaji wa siri na ushauri nasaha unaotolewa na wafanyakazi wa afya waliofunzwa. Kujua hali yako ya VVU ni mojawapo ya hatua muhimu zaidi katika kulinda afya yako na kuzuia maambukizi ya VVU.

Vijana wengi huepuka kupima kwa sababu wanaogopa matokeo au wanaogopa kuhukumiwa. Hata hivyo, upimaji wa VVU haimaanishi kwamba mtu ana VVU. Humsaidia tu mtu kujua hali yake na kupokea taarifa na usaidizi unaofaa. Ikiwa kipimo ni hasi, watoa huduma za afya wanaweza kutoa mwongozo wa jinsi ya kubaki bila VVU. Ikiwa kipimo ni chanya, matibabu ya mapema huwawezesha watu wanaoishi na VVU kuishi maisha marefu, yenye afya njema, na yenye tija. Huduma za upimaji wa VVU zinapatikana katika vituo vya afya kote Tanzania na ni za siri.
...
Vijana wanapaswa kuzingatia upimaji wa VVU ikiwa wamewahi kufanya ngono bila kinga, wanapanga uhusiano, wana dalili za magonjwa ya zinaa, wana mimba, wamepitia unyanyasaji wa kijinsia, au wanataka tu kujua hali yao ya VVU. Upimaji ni wa hiari, wa siri, na kwa kawaida hujumuisha ushauri nasaha wa kabla na baada ya kipimo.`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.EN,
      messageText: `HIV services in Morogoro also include STI screening, family planning services, GBV screening, and referrals to treatment and care when needed.The following are the referral points in morogoro
Morogoro Municipal
...
`,
    ...
    },
    {
      ...
      nodeType: NodeType.RELATED_TOPICS,
      language: Language.SW,
      messageText: `Huduma za VVU mjini Morogoro pia zinajumuisha uchunguzi wa magonjwa ya zinaa, huduma za uzazi wa mpango, uchunguzi wa GBV, na rufaa za matibabu na huduma inapohitajika. Zifuatazo ni sehemu za rufaa mjini Morogoro
