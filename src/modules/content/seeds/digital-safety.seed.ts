...
export const digitalSafetyAndMentalWellbeingSeed = {
  ...
  subtopics: [
    ...
    },
    {
      ...
      titleEn: 'Seeking Mental Health Support',
      titleSw: 'Kutafuta Msaada wa Afya ya Akili',
      descriptionEn: null,
      descriptionSw: null,
      audienceGender: null,
      ageBandRule: null,
...
Understanding mental health helps adolescents:
    ● Manage emotions.
    ● Build resilience.
...
Kwa Nini Vijana Wanapaswa Kujali Afya ya Akili?
...
Kuelewa afya ya akili huwasaidia vijana:
    ● Kudhibiti hisia.
...
Ishara za Mtu Anaweza Kuwa Anapambana
...
Dalili za kimwili zinaweza kujumuisha:
    ...
    ● Uchovu
    ● Ugumu wa kulala
    ● Dalili za kihisia zinaweza kujumuisha:
    ● Kuhisi kuzidiwa
    ● Kukasirika
    ● Kukata tamaa
    ● Wasiwasi
...
Dalili za kitabia zinaweza kujumuisha:
    ● Kuepuka majukumu
    ● Ugumu wa kuzingatia
    ● Kulia mara nyingi
...
Njia Bora za Kudhibiti Msongo wa Mawazo
...
Katika kipindi hiki, kujithamini kunaweza kuathiri sana jinsi vijana wanavyojiona na chaguzi wanazofanya. 
Kijana mwenye kujithamini kiafya ana uwezekano mkubwa wa:
    ...
    ● Self-esteem develops over time through experiences and interactions.
    ...
    ● Kujithamini hukua baada ya muda kupitia uzoefu na mwingiliano.
...
Haimaanishi kuwa na furaha wakati wote. Kila mtu hupata hisia tofauti kama vile furaha, huzuni, hasira, hofu, msisimko, kukata tamaa, na upweke.
...
Wakati ustawi wa kihisia unapokuwa imara, vijana wanaweza kushughulikia msongo wa mawazo, kujenga mahusiano yenye afya, kufanya maamuzi yenye uwajibikaji, na kupona kutokana na kukata tamaa.
...
It is important to remember that experiencing sadness, frustration, or worry sometimes is normal. 
...
Ni muhimu kukumbuka kwamba wakati mwingine kupata huzuni, kuchanganyikiwa, au wasiwasi ni kawaida.
...
Katika nyakati ngumu kama migogoro ya kifamilia, kufiwa na mpendwa, vurugu, unyanyasaji, ujauzito, au mabadiliko makubwa ya maisha, kutafuta msaada huwa muhimu zaidi.
